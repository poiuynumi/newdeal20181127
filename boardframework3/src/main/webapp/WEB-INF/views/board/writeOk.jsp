...
<script>
	$(document).ready(function(){
		...
		$("#viewBtn").click(function(){
			$("#seq").val("${wseq}");	//$("").val(); : getter,$("").val("지정할것"); :setter
			$("#commonForm").attr("method","get").attr("action", viewPath).submit();	//public의 commonForm을 get방식으로 받아 
		});
...
<table width="100%" cellpadding="6" cellspacing="2" border="0"
	...
	<tr>
		...
		<br>
	<div align="center">
		<img src="${root}/img/board/b_wirtecf.gif" width="91" height="21" id="viewBtn"
