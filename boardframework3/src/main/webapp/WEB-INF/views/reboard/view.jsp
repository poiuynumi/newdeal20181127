...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
	...
	<tr height="26">
		<td width="100%" style="padding-left: 14px"><font class="stext">${article.seq}
		:</font> <font class="text_commentnum">${article.seq}</font> &nbsp; <font
			class="stext">${article.name}</font> <a href="javascript:;"
			onClick="showSideView();" class="link_board_02">${article.name}</a><br>
		</td>
		<td style="padding-right: 14px" nowrap class="stext">${article.hit}<font
			class="text_commentnum">${article.hit}</font> &nbsp; 스크랩 : <font
			class="text_commentnum">0</font> &nbsp; ${article.logtime} <font
			class="text_commentnum"> ${article.logtime} 출력하는 부분</font></td>
	</tr>
	<tr>
		<td class="bg_board_title_02" colspan="2" height="1"
			style="overflow: hidden; padding: 0px"></td>
